package com.example.firebaseauthexample.customview.OTPView;
...
public class OtpTextView extends FrameLayout {
    ...
    private void generateViews(TypedArray styles, AttributeSet attrs) {
        ...
        if (length > 0) {
            ...
            int width = (int) styles.getDimension(R.styleable.OtpTextView_width, MyUtils.getPixels(context, DEFAULT_WIDTH));
            int height = (int) styles.getDimension(R.styleable.OtpTextView_height, MyUtils.getPixels(context, DEFAULT_HEIGHT));
            int space = (int) styles.getDimension(R.styleable.OtpTextView_box_margin, MyUtils.getPixels(context, DEFAULT_SPACE));
            int spaceLeft = (int) styles.getDimension(R.styleable.OtpTextView_box_margin_left, MyUtils.getPixels(context, DEFAULT_SPACE_LEFT));
            int spaceRight = (int) styles.getDimension(R.styleable.OtpTextView_box_margin_right, MyUtils.getPixels(context, DEFAULT_SPACE_RIGHT));
            int spaceTop = (int) styles.getDimension(R.styleable.OtpTextView_box_margin_top, MyUtils.getPixels(context, DEFAULT_SPACE_TOP));
            int spaceBottom = (int) styles.getDimension(R.styleable.OtpTextView_box_margin_bottom, MyUtils.getPixels(context, DEFAULT_SPACE_BOTTOM));
