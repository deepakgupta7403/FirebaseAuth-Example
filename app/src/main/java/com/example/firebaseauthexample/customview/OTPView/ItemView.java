...
public class ItemView extends FrameLayout {
    ...
    private void generateViews(TypedArray styles) {
        float defaultHeight = MyUtils.getPixels(context, DEFAULT_BAR_HEIGHT);
        float defaultOtpTextSize = MyUtils.getPixels(context, DEFAULT_OTP_TEXT_SIZE);
        ...
        float barMargin = styles.getDimension(R.styleable.OtpTextView_bar_margin, MyUtils.getPixels(context, 0));
